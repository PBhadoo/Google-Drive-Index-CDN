const len=window.drive_names.length;let html="";for(let t=0;t<len;t++)html+='<a href="/'+t+`:/" style="color: ${UI.folder_text_color};" class="list-group-item list-group-item-action">
       ...
       </svg> `+window.drive_names[t]+"</a>";$("#n_drives").html(len),$("#list").html(html);
